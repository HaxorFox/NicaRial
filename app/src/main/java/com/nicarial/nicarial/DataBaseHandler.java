...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    private static final String TABLE_CONTACTS = "feedbacks";
    ...
    // Adding new contact
    public void addContract(Contract contact) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_NAME, contact.getName()); // Contact Name
        values.put(KEY_COMMENT, contact.getComment()); // Contact Phone Number
    ...
    public int updateContract(Contract contact) {
        SQLiteDatabase db = this.getWritableDatabase();
